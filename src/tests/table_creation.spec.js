...
import { ERROR_SAMPLES, SAMPLES } from '../constants';


test.describe('Check bad build of tables', async () => {

  for (const SAMPLE of ERROR_SAMPLES) {
    test(`Integrity of table #${SAMPLE.name}`, async ({ page }, testInfo) => {
      ...
      await expect(hasRed).toBeTruthy();
    });
  }
